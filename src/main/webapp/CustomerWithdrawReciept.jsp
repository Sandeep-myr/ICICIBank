	...
	<div class="container">
		...
		<div class="details">
			...
			try {
				...
				stmt.executeQuery("select * from " + request.getParameter("from-account") + "  order by tradate desc");
			...
			<p>
				...
				<%=request.getParameter("from-account")%></p>
			<p>
			...
			<p>
				...
				<%=request.getParameter("payee-name")%></p>
			<p>
			<p>
				<strong>Transaction Type:</strong>
				<%=request.getParameter("transaction-type")%>
			</p>
			...
			<p>
				...
				<%=request.getParameter("transaction-reference")%>
			</p>
		...
		<div class="buttons">
			<div class="button"
				onclick="goBackTwoSteps()">Done</div>
